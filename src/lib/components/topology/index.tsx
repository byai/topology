...
export interface ITopologyProps {
    ...
    layoutToolName?: string;
    toCenterToolName?: string;
    downloadToolName?: string;
    downloadLoadingToolName?: string;
}
...
class Topology extends React.Component<ITopologyProps, ITopologyState> {
    ...
    renderToolBars = () => {
        ...
        const { showCenter, showLayout, showDownload, downloadImg, customToolboxList, toCenterToolName, layoutToolName, downloadLoadingToolName, downloadToolName } = this.props;
        /* eslint-disable */
        // @ts-ignore
            ...
            <div className="topology-tools" data-html2canvas-ignore={false}>
                ...
                >
                    <img
                        ...
                        alt=""
                    />
                    <div className="tooltip">{toCenterToolName || '定位中心'}</div>
                </div>}
                ...
                >
                    <img
                        ...
                        alt=""
                    />
                    <div className="tooltip">{toCenterToolName || '自动布局'}</div>
                </div>}
                ...
                >
                    ...
                    <div className="tooltip">{loading? (downloadLoadingToolName || '导出中...') : (downloadToolName || '导出图片')}</div>
                </div>}
