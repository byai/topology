        ...
        return (
            <div className="topology-tools">
                ...
                <div className="topology-tools-zoom" onClick={this.zoomIn}>
                    <img
                        src="https://cdn.byai.com/static/oss-script/86e0beab7ddc653b754613005ed8b40a.svg"
                        alt=""
                    />
                </div>
                ...
                <div className="topology-tools-zoom" onClick={this.zoomOut}>
                    <img
                        src="https://cdn.byai.com/static/oss-script/f1419d479a9b370a540017cee64de7e7.svg"
                        alt=""
                    />
                </div>
            </div>
